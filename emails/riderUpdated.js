export const riderProfileUpdatedEmailTemplate = ({
  name,
  email,
  phone,
  assignedCity,
...
<head>
  <meta charset="UTF-8" />
  <title>Rider Profile Updated</title>
...
<body>
  <div class="email-container">
    <div class="header">
      ...
      <div class="subtitle">Rider profile updated</div>
    </div>
    <div class="content">
      <h1>Hello, ${name}</h1>
      <p>Your rider profile information was updated. Please review the details below.</p>
      ...
      <div class="note">
        If you did not request this change, contact support at
